    ...
    <div class="col-12">
        <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
            <div>
                ...
                <p class="text-muted mb-0">Buat perusahaan baru.</p>
            </div>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <form action="{{ route('profile.companies.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <div class="d-flex align-items-center gap-3 mb-4">
                                <img id="company-logo-preview" src="{{ asset('be') }}/assets/images/avatar/avatar-16.jpg"
                                ...
                                <div>
                                    <label for="logo" class="btn btn-outline-secondary btn-sm mb-1">
                                        <i class="ri-image-add-line"></i> Upload Logo
                                    </label>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">Simpan Company</button>
