                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        @foreach (\App\Models\WebHomeSection::TYPES as $type => $config)
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('web.home-sections.create', ['type' => $type]) }}">
                                    {{ $config['label'] }}
            ...
            <div class="table-responsive">
                <table class="table table-centered table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center text-muted py-4">Belum ada section. Beranda memakai susunan default.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
